export const tours = [
  {
    ...
    questions: [
			{
				title: "Как называется трехмачтовый боевой корабль, у которого много пушек?",
				type: 0, 
				answers: ["ФРЕГАТ", "ЛИНКОР", "БОТ", "КОРВЕТ"],
				correct: 0,
    	},
			{
				title: "Как называется парусное судно с двумя и более мачтами и косыми парусами?",
				type: 0, 
				answers: ["БРИГ", "БАРК", "ШХУНА", "БРИГАНТИНА"],
				correct: 2,
			},
			{
				title: "Как называется помещение для приготовления пищи на морском судне?",
				type: 0, 
			...
			{
				title: "Как называется жилое помещение на судне для команды и пассажиров?",
				type: 0, 
				answers: ["КРЮЙТ-КАМЕРА", "КАЮТА", "ТАМБУР", "СТОЛОВАЯ"],
				correct: 1,
			},
			{
				title: "Как называется надстройка на верхней палубе, не доходящая до бортов?",
				type: 0, 
			...
			{
				title: "Как называется механическое приспособление для переправы с одного берега на другой?",
				type: 0, 
  ...
  },
	{
		...
		questions: [
			{
				title: "Зачерпнуло ветра белое крыло\nНас с тобой кататься в море унесло",
				type: 0, 
