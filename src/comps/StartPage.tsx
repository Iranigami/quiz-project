    ...
    return(
      <div className="w-[1820px] h-[980px] justify-center items-center top-[50px] mx-auto left-0 right-0 fixed font-inter font-semibold">
        <div className="w-full h-[134px] rounded-[20px] bg-aspide-blue flex p-[20px] justify-between">
					...
					<img src={national} alt="russian national projects" className="w-[116px]" />
        </div>
					...
					<div className="">
						...
						<div className="flex gap-[2px] mt-[2px]">
							<div className="w-full h-[421px] rounded-[20px] bg-aspide-blue justify-center items-center">
								...
								<div className="text-center text-white text-[24px] font-semibold w-[266px] mx-auto leading-[100%] tracking-[-2%]">7 захватывающих этапов</div>
							</div>
							<div className="w-full h-[421px] rounded-[20px] bg-aspide-blue justify-center items-center">
								<img src={img2} alt="image" className="mx-auto mt-[115px]" />
								<div className="text-center text-white text-[24px] font-semibold w-[412px] mx-auto leading-[100%] tracking-[-2%]">Отправься в увлекательное путешествие по загадочным глубинам знаний</div>
							</div>
						</div>
					</div>
        </div>
